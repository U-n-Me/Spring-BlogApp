...
public class BlogController {
	...
	@RequestMapping(path = "/api/blog/{blogId}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public ApiResponseEntity<BlogResponseEntity> getBlog(@PathVariable String blogId) {
		return blogService.getBlog(blogId);
	}
	
	@RequestMapping(path = "/api/allblogs", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public ApiResponseEntity<List<BlogGlimseEntity>> getBlogGlimseAll() {
		return blogService.getBlogGlimseAll();
	}
	
	@RequestMapping(path = "/api/allblogs/{bloggerId}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	@RequestMapping(path = "/api/like/{blogId}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
